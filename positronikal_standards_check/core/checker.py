...
class ValidationResult:
    ...
    def add_fail(self, check_name: str, message: str):
        ...
        self.failed.append({"check": check_name, "status": "fail", "message": message})

    def add_warning(self, check_name: str, message: str):
        """Record a warning."""
        self.warnings.append(
            {"check": check_name, "status": "warning", "message": message}
        )

    def add_error(self, check_name: str, message: str):
        """Record an error during checking."""
        self.errors.append({"check": check_name, "status": "error", "message": message})
