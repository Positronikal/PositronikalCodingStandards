...
class BuildSystemValidator:
    ...
    REQUIRED_NPM_SCRIPTS = {"prepare": "husky", "pre-commit": "lint-staged"}
    ...
    def _check_npm_requirements(self) -> List[Dict]:
        ...
        try:
                    ...
                    results.append(
                        {
                            ...
                            "status": "pass",
                            "message": (
                                f"Required package {package} found in devDependencies"
                            ),
                        }
                    )
                else:
                        ...
                        results.append(
                            {
                                ...
                                "status": "warning",
                                "message": (
                                    f"Script '{script_name}' exists but value differs: "
                                    f"expected '{expected_value}', "
                                    f"got '{scripts[script_name]}'"
                                ),
                            }
                        )
                else:
            ...
            if (
                "lint-staged" in package_data
                or (self.repo_path / ".lintstagedrc").exists()
            ):
                results.append(
                    {
                        ...
                        results.append(
                            {
                                ...
                                "status": "pass",
                                "message": (
                                    f"Git hook exists and is executable: {hook_path}"
                                ),
                            }
                        )
                    else:
                        results.append(
                            {
                                ...
                                "status": "warning",
                                "message": (
                                    f"Git hook exists but is not executable: "
                                    f"{hook_path}"
                                ),
                            }
                        )
    ...
    def _check_non_js_hooks(self) -> List[Dict]:
        """Check for required git hooks on non-JS/TS projects."""
        results = []
                    ...
                    results.append(
                        {
                            ...
                            "status": "warning",
                            "message": (
                                f"Git hook exists but is not executable: {hook_path}"
                            ),
                        }
                    )
                else:
            ...
            results.append(
                {
                    ...
                    "status": "pass",
                    "message": (
                        f"Security review command found: {self.SECURITY_REVIEW_COMMAND}"
                    ),
                }
            )
        else:
            results.append(
                {
                    ...
                    "status": "fail",
                    "message": (
                        f"Missing security review command: "
                        f"{self.SECURITY_REVIEW_COMMAND}"
                    ),
                }
            )
            ...
            results.append(
                {
                    ...
                    "status": "warning",
                    "message": (
                        "No GNU configure script found (required for C/C++ projects)"
                    ),
                }
            )
            ...
            results.append(
                {
                    ...
                    "status": "warning",
                    "message": (
                        "No Makefile.am found (recommended for GNU Make projects)"
                    ),
                }
            )
                        ...
                        results.append(
                            {
                                ...
                                "status": "warning",
                                "message": (
                                    f"Action {action} uses unpinned version: {version}"
                                ),
                            }
                        )
                        ...
                        results.append(
                            {
                                ...
                                "status": "pass",
                                "message": (
                                    f"GitHub official action {action} uses "
                                    f"wildcard (allowed)"
                                ),
                            }
                        )
                        ...
                        results.append(
                            {
                                ...
                                "status": "pass",
                                "message": (
                                    f"Action {action} uses pinned version: {version}"
                                ),
                            }
                        )
                ...
                results.append(
                    {
                        ...
                        "status": "fail",
                        "message": (
                            f"Error reading workflow file {workflow_file.name}: {e}"
                        ),
                    }
                )
